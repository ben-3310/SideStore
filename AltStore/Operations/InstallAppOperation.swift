    ...
    private func handleSelfReinstallationAndPrompt(for installedApp: InstalledApp, installing: UnsafeMutablePointer<Bool>) {
        ...
        Task { @MainActor in
            ...
            case .authorized, .ephemeral, .provisional:
                ...
                content.body = "ben4Store will automatically move to the homescreen to finish refreshing!"
            ...
            default:
                ...
                let alert = UIAlertController(title: "Finish Refresh", message: "Please reopen ben4Store after the process is finished.To finish refreshing, ben4Store must be moved to the background. To do this, you can either go to the Home Screen manually or by hitting Continue. Please reopen ben4Store after doing this.", preferredStyle: .alert)
